// ============================================================================
//  GeminiOptions � Configuraci�n del provider Gemini (D4)
// ----------------------------------------------------------------------------
//  Bind desde la secci�n "Gemini" de la configuraci�n.
//
...
//  ApiKey vac�o como marcador).
//
//  ModelId: por defecto gemini-2.5-flash. Free tier de Google AI Studio
//  alcanza para todos los nodos del MVP. Si en E2E alg�n nodo necesita
//  m�s razonamiento, se puede agregar override por nodo en D7.
// ============================================================================
