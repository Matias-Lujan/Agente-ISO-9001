// ============================================================================
//  WorkflowController — RESERVADO PARA EL WORKFLOW REAL (futuro).
//
//  Comentado a propósito: depende de piezas que todavía NO existen en esta
//  rama (ResolutorContextoService, IniciarAuditoriaRequest, ContextoAuditoria).
//  Si se descomenta tal cual, el backend NO compila.
//
//  Los endpoints que el frontend usa hoy los maneja AuditoriaController:
//    POST /api/auditorias
//    GET  /api/auditorias/{id}
//    GET  /api/auditorias/{id}/progreso
//
//  Cuando se implemente el orquestador real, retomar este esqueleto.
// ============================================================================
