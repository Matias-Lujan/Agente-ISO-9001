...
/// <summary>
/// Calcula el <c>HashContenido</c> de un documento recolectado
/// (SHA-256 hex en minúsculas) según las reglas del contrato del agente
/// (<c>contratos_agentes.md §3.2</c>, <c>DocumentoEncontrado</c>):
/// </summary>
/// <list type="bullet">
///   <item><description>
///     <b>Fuentes con archivo binario</b> (<see cref="FuenteDocumento.Drive"/>):
...
///     el hash se calcula sobre el <b>texto canónico ya normalizado</b>
///     (UTF-8 / NFC).
///   </description></item>
/// </list>
/// <remarks>
