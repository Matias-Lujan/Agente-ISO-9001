...
public class ISOAuditAgentDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        // === Convenci�n global: snake_case para tablas y columnas ===
        ...
        // === Enums guardados como texto (en lugar de n�mero) ===
        ...
        // === Seed de configuraci�n del sistema ===
        // path_carpeta_templates: carpeta donde viven los templates de los
        // artefactos. ResolutorContextoService la lee (v�a IConfiguracionRepository)
